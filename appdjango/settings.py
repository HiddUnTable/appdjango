...
SECRET_KEY = 'django-insecure-!6ca@!vtx129w0laol6m5ec-fl=nj($^&h1y9$o-*(o&(1u@44'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'intern_django',  # Nama database Anda
        'USER': 'postgres',      # Nama pengguna PostgreSQL
        'PASSWORD': 'Dar.123',  # Password untuk pengguna PostgreSQL
